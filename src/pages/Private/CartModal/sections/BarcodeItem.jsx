...
import { X, Minus, Plus, Package2, Search, Loader } from 'lucide-react';
...
const BarcodeModal = ({ isOpen, onClose,  onAddToCart }) => {
                ...
                <div className="flex items-end flex-col space-y-2">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <input
                      ...
                      className="w-20 text-center border border-gray-300 dark:border-gray-600 rounded-lg p-2 bg-white dark:bg-gray-800"
                    />
                    <button

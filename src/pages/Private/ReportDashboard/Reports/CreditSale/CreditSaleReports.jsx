...
function CreditSaleReports() {
  ...
  const headers = [
    ...
    { key: "InvoiceCharges", label: "InvoiceCharges" },
  ...
  const getData = async () => {
    ...
    const response = await getRequest(
      `reports/credit-sale/?startDate=${formated_startdate}&endDate=${formated_endDate}`
    );
...
export default CreditSaleReports;

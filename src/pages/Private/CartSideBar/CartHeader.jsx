...
//   };
  ...
  return (
    <div className="p-2 flex items-center  border-b bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700 shadow-sm">
      <div className="flex px-4  w-full items-center justify-between gap-6">
        {/* <CartInfo /> */}
        {/* <TableInfo />         */}
         
          {showScan&&<ScannOpenButton showText = {false}/>}

...
const MenuDetailView = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      ...
      <div className="container mx-auto px-4 mt-5 pb-32 lg:max-w-7xl overflow-y-auto hide-scrollbar">
        <div className="flex flex-col lg:flex-row gap-8">
          {/* Left Section - Main Details */}

          <div className="lg:w-1/2 space-y-6 max-h-[calc(100vh-90px)]">
            <div className="flex flex-row md:flex-col gap-4 md:gap-1">
          ...
          <div className="lg:w-1/2 space-y-6 max-h-[calc(100vh-90px)] overflow-y-auto hide-scrollbar">
            ...
            >
              ...
              {/* {food.PackingPreference == 1 && (
                <button
                  onClick={() => toggleSection("packingpreferences")}
                  className={`flex items-center justify-center py-3 rounded-lg transition-all duration-300 ${
                    expandedSection === "packingpreferences"
                      ? "bg-green-600 text-white"
                      : "bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-200 hover:bg-gray-300 dark:hover:bg-gray-600"
                  }`}
                >
                  <span className="mr-2">Packing Preferences</span>
                  {expandedSection === "packingpreferences" ? (
                    <ChevronUp />
                  ) : (
                    <ChevronDown />
            ...
            {/* {expandedSection === "packingpreferences" && (
              <PackingPreference
                selectedPreference={selectedPackingPreference}
                onPreferenceChange={onchangePackingPreferenc}
                Prefferences={packingPreference}
                clearTrigger={clearPrefTrigger}
              />
            )} */}
            ...
            {expandedSection === "addons" &&
              (addOns && addOns.length > 0 ? (
                <div className="space-y-3 max-h-[calc(100vh-350px)] overflow-y-auto hide-scrollbar">
                  {cartItemCode != 0 && (
